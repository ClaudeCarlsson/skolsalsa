...
const translations = {
  ...
  "meta.home.description": {
    sv: "Jämför svenska grundskolors meritvärden, residualer och gymnasiebehörighet med Skolverkets SALSA-modell. 1 500+ skolor i 290 kommuner, data 1998–2025. Sök, filtrera och jämför skolor gratis.",
    en: "Compare Swedish compulsory school merit values, residuals and gymnasiet eligibility using Skolverket's SALSA model. 1,500+ schools across 290 municipalities, data 1998–2025. Search, filter and compare schools for free.",
  },
  "meta.school.title": {
  ...
  "meta.school.description": {
    sv: "Se hur {name} i {municipality} presterar jämfört med SALSA-modellens förväntade värde. Meritvärde: {merit}, residual: {residual}. Trender, gymnasiebehörighet och elevsammansättning 1998–2025.",
    en: "See how {name} in {municipality} performs vs SALSA model prediction. Merit: {merit}, residual: {residual}. Trends, eligibility and student demographics 1998–2025.",
  },
  "meta.muni.title": {
  ...
  "meta.muni.description": {
    sv: "Alla grundskolor i {name} kommun — meritvärden, residualer och gymnasiebehörighet från SALSA-modellen. {count} skolor rankade och jämförda.",
    en: "All compulsory schools in {name} municipality — merit values, residuals and eligibility from the SALSA model. {count} schools ranked and compared.",
  },
  "meta.munis.title": { sv: "Alla kommuner — SkolSalsa", en: "All municipalities — SkolSalsa" },
  "meta.munis.description": {
    sv: "Bläddra bland alla 290 svenska kommuner. Se antal skolor med SALSA-data per kommun. Hitta och jämför grundskolor i din kommun.",
    en: "Browse all 290 Swedish municipalities. See school count with SALSA data per municipality. Find and compare compulsory schools in your area.",
  },
  "meta.search.title": { sv: "Sök skolor — SkolSalsa", en: "Search schools — SkolSalsa" },
  "meta.search.description": {
    sv: "Sök bland 1 500+ svenska grundskolor efter namn eller kommun. Hitta meritvärden, residualer och betygsresultat direkt.",
    en: "Search 1,500+ Swedish compulsory schools by name or municipality. Find merit values, residuals and grade results instantly.",
  },
  "meta.compare.title": { sv: "Jämför skolor — SkolSalsa", en: "Compare schools — SkolSalsa" },
  "meta.compare.description": {
    sv: "Jämför upp till 5 svenska grundskolor sida vid sida. Meritvärden, residualer och trender i överlappande diagram. Dela din jämförelse via URL.",
    en: "Compare up to 5 Swedish schools side by side. Merit values, residuals and trends in overlapping charts. Share your comparison via URL.",
  },
  "meta.trends.title": { sv: "Nationella trender — SkolSalsa", en: "National trends — SkolSalsa" },
  "meta.trends.description": {
    sv: "Nationella trender för svenska grundskolors meritvärden och gymnasiebehörighet 1998–2025. Se hur skolresultaten utvecklats under 28 år.",
    en: "National trends for Swedish school merit values and gymnasiet eligibility 1998–2025. See how school results have evolved over 28 years.",
  },
  "meta.about.title": { sv: "Om SALSA-modellen — SkolSalsa", en: "About the SALSA model — SkolSalsa" },
  "meta.about.description": {
    sv: "Lär dig hur Skolverkets SALSA-modell fungerar. Bakgrundsfaktorer, regressionsanalys, residualer och modellens utveckling 1998–2025 förklarade på ett enkelt sätt.",
    en: "Learn how Skolverket's SALSA model works. Background factors, regression analysis, residuals and model evolution 1998–2025 explained in plain language.",
  },
